...
def compute_metrics(config,
    ...
    for scale_txt in scales_txt:
        for scale_img in scales_img:
            ...
            assert num_samples <= len(dataset), f"Dataset only has {len(dataset)} samples, but you requested {num_samples}"
...
def main():
    ...
    parser.add_argument("--dataset", default="data/dataset_anime_filtered/", type=str)
